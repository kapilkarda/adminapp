...
class Account extends React.Component {
  ...
  componentDidMount(){
    this.setState({
      ...
      lastname:this.props.me.givenName ? this.props.me.givenName : this.props.me.lastname,
      email:this.props.me.email,
      password:this.props.me.password,
      image:this.props.me.image,
  ...
  editprofile(){
    let { firstname, lastname, email, password, image, name, phone, _id } = this.state
    this.props.actions.editprofile( name, firstname, lastname, email, password, image, phone, _id )
  }
