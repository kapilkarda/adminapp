...
class Editimagename extends PureComponent {
  ...
  onRefresh(){
    ...
    axios.get(`http://3.92.60.33:8083/api/members/fetch-images` + this.props._id)
    .then(res => {
      const results = res.url;
      this.setState({ name : results });
      console.log(' edit profile ',  results)
