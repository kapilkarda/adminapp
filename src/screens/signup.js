...
import { Text, View, StyleSheet, Image, TouchableOpacity, TextInput, KeyboardAvoidingView } from 'react-native'
...
class Test extends React.Component {
  ...
  continue(){
    ...
    this.props.actions.register(name, email, password, this.props.image)
